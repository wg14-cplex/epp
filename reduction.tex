...
an unqualified arithmetic or pointer to object
or complete structure or union type.%
\footnote{EN:
...
If the combiner operation is a compound assignment operator
($op$=),
the combination is performed by executing:

\begin{bnf}
into_view op\terminal{=} from_view\terminal{;}
\end{bnf}
...
\sclause{Integration with the standard}
...
Add a new subclause to subclause 6.3.2 "Other operands":

\begin{quote}
\textbf{6.3.2.3a Reductions}
